...
int main(int , char **)
{
    ...
    std::cout << "Authors: Anubhab Mukherjee and Soham Kar.\nThis is just a replication of the original project, for the demonstration of ReSourcer\n"
	      << "Find the original at https://github.com/2bit-hack/n-queens-problem\n" 
              << "Enter n:\n";
    std::cin >> n;
    if(n<4)
    {
...
void ChessBoard::setN(size_t N)
{
    ...
    image.loadFromMemory(ReSourcer::rawItem("queen"),ReSourcer::itemSize("queen"));
...
void ChessBoard::draw()
{
    ...
    texture.loadFromMemory(ReSourcer::rawItem("queen"),ReSourcer::itemSize("queen"));
